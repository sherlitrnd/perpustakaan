...
if (isset($_POST["action"])) {
  ...
  if ($_POST["action"] == "insert") {
    ...
    $sql = "insert into buku values ('$kode','$judul','$penulis','$stok','$tgl_register','$filename')";
    ...
    if (!empty($_FILES["image"]["name"])) {
      ...
      // rand -> mengambil nilai random 1-1000, exp: 123-800.jpg
      move_uploaded_file($_FILES["image"]["tmp_name"],"image_buku/".$filename);
      $sql = "update buku set judul='$judul', penulis='$penulis',stok='$stok',tgl_register='$tgl_register',image='$filename' where kode_buku='$kode'";
    } else {
      $sql = "update buku set judul='$judul', penulis='$penulis',stok='$stok',tgl_register='$tgl_register', where kode_buku='$kode'";
    }
